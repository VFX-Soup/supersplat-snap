...
import { AlignTool } from './tools/align-tool';
...
const main = async () => {
    ...
    try {
        toolManager.register('align', new AlignTool(events, scene, editorUI.toolsContainer.dom, editorUI.canvasContainer));
    } catch (e) {
        console.error('[AlignTool] Failed to initialize:', e);
    }
